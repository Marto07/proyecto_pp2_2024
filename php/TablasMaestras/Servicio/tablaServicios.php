...
<body>
	...
	<table>
		...
		<?php foreach ($registros as $reg) : 
			...
			$modificar = "<a href='tablaservicios_modificacion.php?id_servicio=$id'>
		...
		<?php endforeach; ?>
 		...
 		<tr>
 			<td colspan="8" class="alta">
 				<a href="tablaservicios_alta.php">
 	...
 	<script>
        function confirmDelete(id) {
            ...
            if (respuesta) {
                ...
                window.location.href = "tablaservicios_baja.php?id_servicio=" + id;
            }
        }
    </script>
</body>
