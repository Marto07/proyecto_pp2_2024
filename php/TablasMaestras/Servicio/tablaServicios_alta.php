...
<body>
    ...
    <h1 style="text-align: center; margin-top: 25px; margin-bottom: 20px; color: white;">Modulo Alta de servicios</h1>
    <form action="tablaservicios_aplicar_alta.php" method="post">
