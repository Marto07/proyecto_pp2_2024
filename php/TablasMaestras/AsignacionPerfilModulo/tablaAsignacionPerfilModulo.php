<?php 
	...
	$registros = obtenerPerfilesModulos();
?>
...
<head>
	...
	<title>Tabla Perfiles por Modulos</title>
	<style>
		/* GENERALES */
		body{
			padding: 0;
...
<body>
	<h1 style="text-align: center; margin-top: 25px; margin-bottom: 20px;">Modulo de Perfiles por Modulos</h1>
	...
	<table>
		...
		<?php foreach ($registros as $reg) : 
			...
			$id 		 = $reg['id_asignacion_perfil_modulo'];
			$modulo = $reg['descripcion_modulo'];
			$perfil   = $reg['descripcion_perfil'];

			$modificar = "<a href='tablaasignacionperfilmodulo_modificacion.php?id_asignacion_perfil_modulo=$id'>
		...
		<?php endforeach; ?>
 		...
 		<tr>
 			<td colspan="8" class="alta">
 				<a href="tablaasignacionperfilmodulo_alta.php">
 	...
 	<script>
        function confirmDelete(id) {
            ...
            if (respuesta) {
                ...
                window.location.href = "tablaasignacionperfilmodulo_baja.php?id_asignacion_perfil_modulo=" + id;
            }
        }
    </script>
</body>
