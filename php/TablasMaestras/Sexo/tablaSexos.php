...
<body>
	<h1 style="text-align: center; margin-top: 25px; margin-bottom: 20px;">Modulo de sexos</h1>
	...
	<table>
		...
		<?php foreach ($registros as $reg) : 
			...
			$modificar = "<a href='tablaSexos_modificacion.php?id_sexo=$id'>
 	...
 	<script>
        function confirmDelete(id) {
            ...
            if (respuesta) {
                ...
                window.location.href = "tablaSexos_baja.php?id_sexo=" + id;
            }
        }
    </script>
</body>
