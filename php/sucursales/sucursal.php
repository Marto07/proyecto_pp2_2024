...
if (isset($_GET['id_sucursal'])) {
	...
	$getSucursalId = $_GET['id_sucursal'];
} else {
	echo "ocurrio un error :( No hay GET de sucursal";
	die;
}
...
if (isset($_SESSION['perfil'])) {
	...
	echo "ocurrio un error :( No hay sesion";
	die;
}
	...
	<div class="contenido">
		...
		<div class="container">
			...
			<div class="mitadSuperior">
				...
				<div class="contenedor-foto" style="background-image:url(<?php echo BASE_URL . 'assets/img/l_1573770810.jpg'; ?>);">
				...
				<div class="info">
					<h3><?php echo $nombre_sucursal; ?></h3>
					<h4>Contacto! <?php if (isset($contacto)) {
										echo $contacto;
									} else {
										echo "...";
									} ?></h4>
					<a href="<?php echo BASE_URL . "php/complejos/hacerse_socio.php?id_usuario=$id_usuario&id_complejo=$id_complejo"; ?>">Hazte Socio!</a>
					<a href="<?php echo BASE_URL . "modules/canchasGestion/php/canchaReserva.php?id_sucursal=$getSucursalId&id_complejo=$id_complejo"; ?>">Ver Reservas</a>
				</div>
			...
			<div class="mitadInferior">
				...
				<div class="canchas">
					...
					<?php
						...
						echo "<h2 align='center'>No hay canchas...</h2>";
					}
					?>
