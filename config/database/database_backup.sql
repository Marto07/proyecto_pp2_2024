...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-10-2024 a las 22:09:51
...
INSERT INTO `documento` (`id_documento`, `descripcion_documento`, `estado`, `rela_tipo_documento`, `rela_persona`) VALUES
(13, '15.253.244', 1, 1, 12),
(14, '15.253.2441', 1, 1, 13),
(15, 'a', 1, 1, 15),
(17, '24454253', 1, 1, 17),
(18, '42757241', 1, 1, 18),
(19, 'documento-NO-USUARIO', 1, 1, 19),
(21, '42757241', 1, 2, 21),
(23, '4289726', 1, 1, 23),
(24, '789444543', 1, 1, 24),
(25, '427572411', 1, 1, 25),
(26, '78944454322', 1, 1, 26),
(27, '124151351531', 1, 1, 27),
(28, '89472816', 1, 1, 28),
(29, '42897262', 1, 1, 29),
(31, '4297261', 1, 2, 31),
(32, '27124729', 1, 2, 32),
...
(5, NULL, 'Cantinero', '2024-09-19', 1, 26, 1),
(6, NULL, 'Personal Administrativo', '2024-09-19', 1, 27, 1);
...
(1, 'Un usuario reservo una cancha', 'no leido', 1);
...
INSERT INTO `persona` (`id_persona`, `nombre`, `apellido`, `cuil`, `fecha_nacimiento`, `fecha_alta`, `estado`, `rela_sexo`) VALUES
(12, 'Nombre de prueba', 'Apellido de Prueba', NULL, NULL, NULL, 1, 1),
(13, 'edgar', 'coppa', NULL, NULL, NULL, 1, 1),
(15, 'martin', 'coppa', NULL, NULL, NULL, 1, NULL),
(17, 'juan', 'coppa', NULL, NULL, NULL, 1, 2),
(18, 'Roberto', 'Pelaez', NULL, '2000-07-05', '2024-07-01', 1, 1),
(19, 'nombre-NO-USUARIO', 'apellido-NO-USUARIO', '3135151', '2000-08-05', NULL, 1, 1),
(21, 'bob esponja', 'Repetida', NULL, '2024-09-18', '2024-09-10', 1, NULL),
(23, 'Martin socio', 'coppa socio', NULL, '2000-07-05', '2024-09-18', 1, 1),
(24, 'bob esponja', 'pantalones cuadrados', NULL, '2003-02-17', '2024-09-19', 1, 1),
(25, 'patricio', 'estrella', NULL, '2024-09-18', '2024-09-19', 1, NULL),
(26, 'patricio', 'estrella', NULL, '2024-10-12', '2024-09-19', 1, NULL),
(27, 'empleado a borrar', 'empleado borrar', NULL, '2024-09-02', '2024-09-19', 1, NULL),
(28, 'Roberto', 'Tagliari', '37-8972816-1', NULL, NULL, 1, 1),
(29, 'patricio', 'pantalones cuad', NULL, '2000-06-05', '2024-09-20', 1, 1),
(31, 'bob esponja', 'Repetida', NULL, '2000-02-01', '2024-09-20', 1, 2),
(32, 'francisco', 'oneto', NULL, '1999-03-22', '2024-09-20', 1, 1),
(33, 'bob esponja', 'pantalones cuad', NULL, '2000-02-20', '2024-09-20', 1, 1),
(35, 'Nahuel', 'Molinas', NULL, NULL, NULL, 1, 1),
(36, 'Martin', 'Coppa', NULL, '2000-06-13', '2024-10-18', 1, 1),
(37, 'patricio', 'estrella', NULL, '2000-07-04', '2024-10-18', 1, 1),
(38, 'pablo', 'luguercio', NULL, '2000-07-05', '2024-10-18', 1, 1),
(39, 'emanuel', 'Salinas', NULL, '2000-07-05', '2024-10-18', 1, 2),
(40, 'agustin', 'lanata', NULL, '2000-10-05', '2024-10-18', 1, 1),
(41, 'a', 'roman', NULL, '2000-07-05', '2024-10-18', 1, 1);
...
(11, 'maurinasd0001', '$2y$10$Lud5NvNjPmN.L4TnSuiANeOPozQ9vDdM2X4SEbU0rD2VDuBur9ZUi', 'c76731c3fa7ff2f2df68e03d2ca9fbb8', '2024-10-20 23:16:45', 'verificado', 15, 2),
...
ALTER TABLE `documento`
  ...
  ADD KEY `fk_persona_documento` (`rela_persona`);
...
ALTER TABLE `documento`
  ...
  ADD CONSTRAINT `fk_persona_documento` FOREIGN KEY (`rela_persona`) REFERENCES `persona` (`id_persona`);
